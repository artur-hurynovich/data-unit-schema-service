...
public class ModelConstants {
    ...
    public static final Long DATA_UNIT_SCHEMA_ID_1 = 1000L;
    public static final String DATA_UNIT_SCHEMA_NAME_1 = "Schema Name 1";

    public static final Long DATA_UNIT_SCHEMA_ID_2 = 2000L;
    public static final String DATA_UNIT_SCHEMA_NAME_2 = "Schema Name 2";

    public static final Long DATA_UNIT_SCHEMA_ID_3 = 3000L;
